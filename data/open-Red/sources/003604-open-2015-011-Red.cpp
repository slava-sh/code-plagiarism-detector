...
using namespace std;
vector<vector<pair<short, int> > > G;
queue<pair<pair<short, int>, short> > Order;
set<pair<short, int> > Visited;
vector<short> Dist;
...
void bfs()
{
    pair<pair<short, int>, short> Curr = Order.front();
    Order.pop();
    Visited.insert(Curr.first);
    short V = Curr.first.first; int T = Curr.first.second; short Curr_Dist = Curr.second;
