...
void doit(string s){
    ...
    //if(i==n+1){cout<<inc<<endl;return ;}
        ...
        if(sz(s)-le==3){if(s[le]=='0'){continue;}ans+=t(s,le,3);}
        else if(sz(s)-le==4){if(s[le]=='0'){continue;}ans+=t(s,le,2)+"-"+t(s,le+2,2);}
        else if(sz(s)-le==5){if(s[le]=='0'){continue;}ans+=t(s,le,3)+"-"+t(s,le+3,2);}
        else if(sz(s)-le==6){if(s[le]=='0'){continue;}ans+=t(s,le,2)+"-"+t(s,le+2,2)+"-"+t(s,le+4,2);}
        else if(sz(s)-le==7){if(s[le]=='0'){continue;}ans+=t(s,le,3)+"-"+t(s,le+3,2)+"-"+t(s,le+5,2);}
        else {continue;}
        cout<<ans<<endl;
        return;
    }
