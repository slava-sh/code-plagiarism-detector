...
begin
    ...
    if(v.y < -epsilon) then alpha:= 360.0 - alpha;
    GetAngle:= alpha;    
end;
...
function GetTime1(A, v: TCoors; R2: Extended): Extended;
...
function GetTime2(A, v: TCoors; R2: Extended): Extended;
var aa, kk, cc: Extended;
    D, t: Extended;
begin
    aa:= SqrLen(v);
...
Begin
    ...
    While(M>0) do begin
        ...
        for i:= 1 to N do begin
            ...
            t:= GetTime1(a[i], v, SqrLen(G));
            if(t < -epsilon) then continue;
