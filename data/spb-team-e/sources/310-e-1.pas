...
var i, o : text;
    n, m, j, y, l1, r1, l2, r2, sum1, sum2 : int64;
    b : arr;
     ...
     rewrite(o);
          ...
          begin
               if ((j mod 2) = 1) then for y:=1 to n do
                                        begin
                     if (not b[y]) then if r[y] in [l1..r1] then begin b[y]:=true; inc(sum1); break; end
                                        end
                                  else  for y:=1 to n do
                                        begin
                     if (not b[y]) then if r[y] in [l2..r2] then begin b[y]:=true; inc(sum2); break; end;
                                        end;     
