     ...
     begin
          ...
          begin
               ...
               if a1 then  begin b1 := false;
                    for k := 1 to n do begin
                         if (not b[k]) then if r[k] in [l1..r1] then begin b[k] := true; inc(sum1); a1 := true; break; end;
                    a1:=false; end;
               end;
          ...
          begin
               ...
               if a2 then  begin b2 := false;
                    for k := 1 to n do
                    begin
                         if (not b[k]) then if r[k] in [l2..r2] then begin b[k] := true; inc(sum2); a2 := true; break; end;  
                    a2 := false;
                    end;
               end;
