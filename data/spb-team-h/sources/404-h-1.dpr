...
var
  Inp, O: TextFile;
  Arr: Array[0..1000] of array[0..2] of String;
  Arr2: Array[0..1000] of array[0..1] of Int64;
  Arr3: Array[0..100] of array[0..1] of Integer;
  i, j, n: Integer;
  t: String;
  SL: TStringList;
...
begin
  ...
  For i := 0 to N-1 do
  SL.Add(arr[i,2]+' '+arr[i,0]+' '+arr[i,1]);
