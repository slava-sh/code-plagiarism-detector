...
#define ff first
#define ss second
long long n, m, g[5009][5009], d[100009], ind, u[100009],ans=INF,in[5009],ot[100009],ku[100009],st[100009],ansot,ansku, de[100009], ind1;
int ser,der,asd;
        ...
        for(int k=1;k<=n;k++)
        {
            if(g[ind][k]!=0)
                if(d[ind]+g[ind][k]<d[k])
                    d[k]=d[ind]+g[ind][k],se.insert(mp(d[k],k));
        }
    }
    as:;
//    cout<<c<<endl;
