           ...
           //         l1++;
             //   }
                for (int g1 = l1; g1 < l[j] && b; g1++) {
                 ...
                 //   cout << g1 + 1 << endl;
                    if (vec(point(p[j][g1 - 1], p[i][g]), point(p[i][g + 1], p[i][g])) == 1 &&
                        vec(point(p[j][g1 + 1], p[i][g]), point(p[i][g + 1], p[i][g])) == 2) {
                        t = false;
                   //     cout << "opa" << endl;
                    }
                          if (vec(point(p[j][g1 - 1], p[i][g]), point(p[i][g + 1], p[i][g])) == 2 &&
                        vec(point(p[j][g1 + 1], p[i][g]), point(p[i][g + 1], p[i][g])) == 1) {
                        t = false;
                   //     cout << "opa" << endl;
                    }
                        if (!t) {
                 ...
                 //   cout << g1 + 1 << endl;
                    if (vec(point(p[j][g1], p[i][g - 1]), point(p[i][g], p[i][g - 1])) == 1 &&
                        vec(point(p[j][g1 - 1], p[i][g - 1]), point(p[i][g], p[i][g - 1])) == 2) {
                        t = false;
                   //     cout << "opa" << endl;
                    }
                    if (vec(point(p[j][g1], p[i][g - 1]), point(p[i][g], p[i][g - 1])) == 2 &&
                        vec(point(p[j][g1 - 1], p[i][g - 1]), point(p[i][g], p[i][g - 1])) == 1) {
                        t = false;
                      //  cout << "opa" << endl;
                    }
                    bool t1 = true;
                    if (vec(point(p[i][g], p[j][g1 - 1]), point(p[j][g1], p[j][g1 - 1])) == 2 &&
                        vec(point(p[i][g - 1], p[j][g1 - 1]), point(p[j][g1], p[j][g1 - 1])) == 1) {
                        t1 = false;
                    }
                    if (vec(point(p[i][g], p[j][g1 - 1]), point(p[j][g1], p[j][g1 - 1])) == 1 &&
                        vec(point(p[i][g - 1], p[j][g1 - 1]), point(p[j][g1], p[j][g1 - 1])) == 2) {
                        t1 = false;
                    }
