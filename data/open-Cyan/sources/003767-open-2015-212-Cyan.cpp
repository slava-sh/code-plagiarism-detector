	...
	for (int i = 1; i < n; ++i) {
		...
		while (true) {
			...
			if (A[i1][p1].first < A[i2][p2].first) {
				...
				double y = A[i2][p2].second - (len3 / len2) * (A[i2][p2].second - A[i2][p2 - 1].second);
				...
				double y = A[i1][p1].second - (len3 / len2) * (A[i1][p1].second - A[i1][p1 - 1].second);
