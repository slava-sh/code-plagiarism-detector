	...
	int intersects(const br_line& x)
	{
		...
		while (it1 < l && it2 < x.l)
		{
			...
			else if (p[it1].x < x.p[it2].x)
			{
				...
				if (eq == 0)
				{
					if ((long double)p[it1].y < y2)
						eq = -1;
					else if ((long double)p[it1].y > y2)
						eq = 1;
				}
			...
			else
			{
				...
				if (eq == 0)
				{
					if ((long double)x.p[it2].y > y2)
						eq = -1;
					else if ((long double)x.p[it2].y < y2)
						eq = 1;
				}
