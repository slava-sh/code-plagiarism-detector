...
int get_coord(int i1, int j1, int x1, int i2, int j2, int x2) {
    double v1 = (1LL * l[i1][j1 - 1].y * (l[i1][j1].x - l[i1][j1 - 1].x) + (0LL + l[i1][j1].y - l[i1][j1 - 1].y) * ((x1 - l[i1][j1 - 1].x + 0.0))) * (l[i2][j2].x - l[i2][j2 - 1].x);
    double v2 = (1LL * l[i2][j2 - 1].y * (l[i2][j2].x - l[i2][j2 - 1].x) + (0LL + l[i2][j2].y - l[i2][j2 - 1].y) * ((x2 - l[i2][j2 - 1].x + 0.0))) * (l[i1][j1].x - l[i1][j1 - 1].x);
    if (v1 == v2) {
        return 0;
    } else if (v1 > v2) {
        return 1;
