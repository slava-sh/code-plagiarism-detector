...
bool contains_x(int s1, int s2)
{
	if (segments[s1].first.first < segments[s2].first.first &&
		segments[s1].second.first > segments[s2].first.first)
		return true;
	if (segments[s1].first.first < segments[s2].second.first &&
		segments[s1].second.first > segments[s2].second.first)
		return true;
	swap(s1, s2);
	if (segments[s1].first.first < segments[s2].first.first &&
		segments[s1].second.first > segments[s2].first.first)
