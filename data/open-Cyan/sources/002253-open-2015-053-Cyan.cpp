...
bool ins(seg a, seg b)
{
	lin q = line(b);
	lin t = line(a);
	if (a.b.y > (-q.c - q.a * a.b.x) / q.b && (-q.c - q.a * a.b.x) / q.b >= min(b.b.y, b.a.y) && (-q.c - q.a * a.b.x) / q.b <= max(b.a.y, b.b.y))
		return 1;
	if (b.b.y < (-t.c - t.a * b.b.x) / t.b && (-t.c - t.a * b.b.x) / t.b >= min(a.b.y, a.a.y) && (-t.c - t.a * b.b.x) / t.b <= max(a.a.y, a.b.y))
		return 1;
	return 0;
}
