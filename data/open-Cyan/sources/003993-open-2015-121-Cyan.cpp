...
{
    if (i.points[0].second <= j.points[0].second && i.points[i.points.size() - 1].second <= j.points[j.points.size() - 1].second)
    {
        return true;
    }
    else if (i.points[0].second >= j.points[0].second && i.points[i.points.size() - 1].second >= j.points[j.points.size() - 1].second)
    {
        return false;
    }
    else if (is_good)
