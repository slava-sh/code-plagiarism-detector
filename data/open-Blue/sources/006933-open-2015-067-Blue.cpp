...
hash get_hash(int l, int r) {
    /*if (preh[l][r] != 0) {
        return hash(preh[l][r]);
    }*/
    //preh[l][r] = ((prec[r + 1] - prec[l] * sprod[r - l + 1]) % mod).a;
...
int check2(int l1, int r1, int l2, int r2, int start) {
    ...
    for (;start < szof(s);) {
        if (start + l1 <= szof(s)) {
            if (get_hash(start, start + l1 - 1) == h1) {
                start += l1;
            } else {
                if (start + l2 <= szof(s) && get_hash(start, start + l2 - 1) == h2) {
                    start += l2;
                } else {
                    return 0;
                }
